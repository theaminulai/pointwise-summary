...
description: Report a bug with the Pointwise Summary WordPress plugin
...
body:
    - type: markdown
      attributes:
          value: |
              Thank you for taking the time to report a bug in the Pointwise Summary plugin! If this is a security issue, please report it privately at https://github.com/theaminulai/pointwise-summary/security.
    ...
    - type: textarea
      attributes:
          ...
          description: |
              Provide details about your environment, including WordPress version, Pointwise Summary version, and other relevant information.
          placeholder: |
              - WordPress version
              - Pointwise Summary version
              - Active theme
              - Browser(s) tested on
    ...
    - type: checkboxes
      ...
      attributes:
          ...
          description: You can search at https://github.com/theaminulai/pointwise-summary/issues to ensure the bug has not already been reported.
          options:
              - label: 'Yes'
                required: true
