...
const getErrorDescription = ( error ) =>
	error instanceof Error
		? error.message
		: __( 'Please try again.', 'pointwise-summary' );
...
export const displaySettingsApi = {
	...
	update: ( settings ) =>
		safeApiRequest( {
			...
			successDescription: __(
				'Your button display settings have been updated.',
				'pointwise-summary'
			),
		} ),
	reset: () =>
		safeApiRequest( {
			...
			errorTitle: __(
				'Failed to reset display settings',
				'pointwise-summary'
			),
			successTitle: __(
...
export const socialSharingApi = {
	get: () =>
		safeApiRequest( {
			...
			errorTitle: __(
				'Failed to load social sharing settings',
				'pointwise-summary'
			),
		} ),
	update: ( settings ) =>
		safeApiRequest( {
			...
			errorTitle: __(
				'Failed to save social sharing settings',
				'pointwise-summary'
			),
			successTitle: __(
			...
			successDescription: __(
				'Your social sharing configuration has been updated.',
				'pointwise-summary'
			),
		} ),
	reset: () =>
		safeApiRequest( {
			...
			errorTitle: __(
				'Failed to reset social sharing settings',
				'pointwise-summary'
			),
			successTitle: __(
				'Social sharing settings reset to defaults',
				'pointwise-summary'
			),
		} ),
};
...
export const advancedSettingsApi = {
	...
	update: ( settings ) =>
		safeApiRequest( {
			...
			successDescription: __(
				'Your advanced configuration has been updated.',
				'pointwise-summary'
			),
		} ),
	reset: () =>
		safeApiRequest( {
			...
			errorTitle: __(
				'Failed to reset advanced settings',
				'pointwise-summary'
			),
			successTitle: __(
...
export const shortcodesApi = {
	get: () =>
		safeApiRequest( {
			request: () => apiRequest( '/shortcodes' ),
			errorTitle: __(
				'Failed to load shortcode examples',
				'pointwise-summary'
			),
		} ),
};
...
export const systemInfoApi = {
	get: () =>
		safeApiRequest( {
			request: () => apiRequest( '/system-info' ),
			errorTitle: __( 'Failed to load system info', 'pointwise-summary' ),
		} ),
};
